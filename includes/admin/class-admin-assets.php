...
class RevIt_Publisher_Admin_Assets {
	...
	public function enqueue_admin_assets( string $hook_suffix ): void {
		$allowed_hooks = array(
			...
			'revit-publisher_page_revit-publisher-seo',
			'revit-publisher_page_revit-publisher-advanced',
			...
			'revit-publisher_page_revit-publisher-search-performance',
			'revit-publisher_page_revit-publisher-editorial',
			'revit-publisher_page_revit-publisher-system-health',
		...
		wp_localize_script(
			...
			array(
				...
				'pages'         => array(
					...
					'seo'               => RevIt_Publisher_Admin::MENU_SLUG . '-seo',
					'advanced'          => RevIt_Publisher_Admin::MENU_SLUG . '-advanced',
					...
					'searchPerformance' => RevIt_Publisher_Admin::MENU_SLUG . '-search-performance',
					'editorial'         => RevIt_Publisher_Admin::MENU_SLUG . '-editorial',
					'systemHealth'      => RevIt_Publisher_Admin::MENU_SLUG . '-system-health',
